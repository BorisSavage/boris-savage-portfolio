...
export default function ContactMe() {
  ...
  const openEmail = (data: Inputs) => {
    window.open(
      `mailto:MBorysewicz@protonmail.com?subject=${data.subject} — ${data.name}&body=${data.message}`,
      "_blank"
    );
  };
    ...
    >
      ...
      <div className="flex flex-col space-y-5 sm:space-y-10">
        <div className="rounded-xl bg-gradient-to-b from-transparent via-mossy_glen-950/20 to-transparent px-2 pb-[7px]">
          <h4 className="text-center text-2xl font-semibold drop-shadow-lg sm:text-4xl">
        ...
        <div className="space-y-5 sm:space-y-10">
          ...
          <div className="mx-auto flex w-fit items-center justify-center space-x-2 rounded-xl bg-gradient-to-b from-transparent via-mossy_glen-950/20 to-transparent px-2 pb-[5px]">
            <EnvelopeIcon className="relative top-[2px] h-7 w-7 text-misty_mountains-100/90 drop-shadow-lg" />
            <p className="text-lg drop-shadow-lg sm:text-2xl">
              MBorysewicz@protonmail.com
            </p>
          </div>
          <div className="mx-auto flex w-fit items-center justify-center space-x-2 rounded-xl bg-gradient-to-b from-transparent via-mossy_glen-950/20 to-transparent px-2 pb-[5px]">
            <MapPinIcon className="relative top-[2px] h-7 w-7 text-misty_mountains-100/90 drop-shadow-lg" />
            <p className="text-lg drop-shadow-lg sm:text-2xl">
        ...
        >
          ...
          <textarea
            ...
            placeholder="Message"
            className="contactInput scrollbar scrollbar-track-sunlit_meadow-300/20 scrollbar-thumb-misty_mountains-500/50 scrollbar-w-1"
          />
          <motion.div
            whileTap={{
              scale: 0.9,
